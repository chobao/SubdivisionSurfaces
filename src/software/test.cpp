...
int testRendering( const CommonUtils::Config& config) {
    ...
    viewer.SetUp(800, 600, config.vertex_shader_path, config.fragment_shader_path, config);
...
int testModel( const CommonUtils::Config& config){
    ...
    GLRendering::Viewer& viewer =  GLRendering::Viewer::Instance();
    viewer.SetUp(scr_width, scr_height, config.vertex_shader_path, config.fragment_shader_path, config);
...
int solve( const CommonUtils::Config& config) {
    ...
    GLRendering::Viewer& viewer =  GLRendering::Viewer::Instance();
    if(viewer.SetUp(scr_width, scr_height, config.vertex_shader_path, config.fragment_shader_path, config)) {
